...
import Login_tippy from "./Login_tippy";
...
const Header = () => {
  ...
  const add_To_Cart = (title, price, image) => {
    ...
    dispatch(TotalItem())
    // console.log("karan",oldData)
    // let newDetails = [title, price];
    // // console.log("jojo", newDetails)
    // setShowData((val) => [...val, newDetails]);
    // console.log(showData)
    // localStorage.setItem("Add_TO_Cart", JSON.stringify(showData))
  };
  ...
  //   dispatch(
  //     DetailViewer({ title, price, description, category, image, rating })
  //   );
  // };
  const getProductDetails = (
    id,
      ...
      <div className="header">
        <div className="header-first">
          ...
          <div className="header_first1">
            <span
              style={{ fondSize: "11px", color: "white", fontStyle: "italic" }}
            >
              Explore
            </span>
            <span
        ...
        <div className="header-fourth">
          <Tippy placement="bottom" content={<MoreInfo />} interactive={true}>
            <span>
              More
              <ExpandMoreIcon />
            </span>
          ...
          {data.length
            ? data
                ...
                .map((d) => {
                  return (
                    <div
                      className=" col-lg-2 col-md-3 col-sm-6 my-2 px-3"
                    ...
                    >
                      ...
                      {/* <div style={{ fontSize:"14px" }}>Category - {d.category.toUpperCase()}</div> */}
                      <div style={{ fontSize: "14px" }}>
                        <b>Price - </b>${d.price}
                      </div>
                      <div style={{ fontSize: "14px" }}>
                        {" "}
                        <b> Rating - </b> {d.rating["rate"]} and{" "}
                        {d.rating["count"]}
                      </div>
                    </div>
                  );
